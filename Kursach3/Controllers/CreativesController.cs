...
namespace Kursach3.Controllers
{
    public class CreativesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,Rank,Count,CreateData,RedactData,UserId")] Creative creative)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,Rank,Count,CreateData,RedactData,UserId")] Creative creative)
        {
            if (ModelState.IsValid)
            {
